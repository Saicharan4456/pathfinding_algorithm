...
text3 = font4.render('CREDIT: Sai Charan', 1, b)
text4 = font4.render('A* Algorithm', 1, b)
...
def draw(grid):
    ...
    win.blit(text3, (BORDER // 2 - text3.get_width() // 2, 120))
    win.blit(text4, (BORDER // 2 - text4.get_width() // 2, 145))
    start_button.draw()
    reset_button.draw()
    for i in range(ROW):
